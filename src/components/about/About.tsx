...
const socials = [
  {
    name: "LinkedIn",
    icon: Linkedin,
    href: "https://www.linkedin.com/in/amarjeet-kumar-b0466424a/",
    color: "from-blue-500 to-cyan-500",
  },
  {
    name: "GitHub",
    icon: Github,
    href: "https://github.com/amarjeet-kumar88",
    color: "from-gray-600 to-gray-900",
  },
  {
    name: "LeetCode",
    icon: Code,
    href: "https://leetcode.com/u/amarjeetmah12345/",
    color: "from-yellow-500 to-orange-500",
  },
  {
    name: "Codeforces",
    icon: Code2Icon,
    href: "https://codeforces.com/profile/amarjeetmah12345",
    ...
    <section id="about" className="py-32 bg-surface overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted">
            Shershah Engineering College, Sasaram (2021 – 2025)
          </p>
        </motion.div>
